...
$ordereds = $order->getOrderByIdKelas($idKelas);
?>
...
<body>
    ...
    <div class="container bootdey">
        <?php foreach ($ordereds as $ordered) : ?>
            <?php
            $idKelas = $ordered['idClass'];
            $kelas = new Kelas();
            ...
            <div class="panel panel-default panel-order">
                ...
                <div class="row" style="width:30%">
                    <div class="col-3">
                        <button class="btn btn-success mx-4 my-3" onclick="window.location.href = 'complainForm.php?orderId=<?= $ordered['idOrder'];?>'">Confirm</button>

                    </div>
                    <div class="col-3">
                        <button class="btn btn-danger mx-4 my-3" onclick="window.location.href = 'complainForm.php?orderId=<?= $ordered['idOrder'];?>'">Reject</button>

                    </div>
                    <div class="col-6 d-flex align-items-center">
                        <h1 class="montserratBold" style="font-size:20px">Confirm in: 3 Days</h1>
